  ...
  return (
    <div className="bg-white">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 p-10 gap-x-40 max-sm:grid-cols-1 max-sm:p-4">
        <div className="w-80 h-52 bg-slate-300 max-sm:mb-12">
